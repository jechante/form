...
export class JobService {
    ...
    private resourceUrl1 = SERVER_API_URL + 'api/jobs-title';
    ...
    findByTitle(title: string): Observable<EntityResponseType> {
        return this.http.get<IJob>(`${this.resourceUrl1}/${title}`, { observe: 'response' });
    }
