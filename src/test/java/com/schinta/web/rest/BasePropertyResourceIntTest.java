...
public class BasePropertyResourceIntTest {
    ...
    private static final String DEFAULT_PROPERTY_TYPE = "A";
    private static final String UPDATED_PROPERTY_TYPE = "B";

    private static final Integer DEFAULT_PROPERTY_SCORE = 1;
    private static final Integer UPDATED_PROPERTY_SCORE = 2;

    private static final String DEFAULT_FORMY_TYPE = "A";
    private static final String UPDATED_FORMY_TYPE = "B";
    ...
    public void setup() {
        ...
        final BasePropertyResource basePropertyResource = new BasePropertyResource(basePropertyRepository);
    ...
    public void createBaseProperty() throws Exception {
        ...
        assertThat(testBaseProperty.getPropertyID()).isEqualTo(DEFAULT_PROPERTY_ID);
    ...
    public void updateBaseProperty() throws Exception {
        ...
        BaseProperty testBaseProperty = basePropertyList.get(basePropertyList.size() - 1);
        assertThat(testBaseProperty.getPropertyID()).isEqualTo(UPDATED_PROPERTY_ID);
