...
import { FormSubmitComponent } from 'app/entities/form-submit/form-submit.component';
...
describe('Component Tests', () => {
    describe('FormSubmit Management Component', () => {
        let comp: FormSubmitComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FormSubmitComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.formSubmits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
