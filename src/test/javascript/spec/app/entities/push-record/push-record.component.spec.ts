...
import { PushRecordComponent } from 'app/entities/push-record/push-record.component';
...
describe('Component Tests', () => {
    describe('PushRecord Management Component', () => {
        let comp: PushRecordComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PushRecordComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pushRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
