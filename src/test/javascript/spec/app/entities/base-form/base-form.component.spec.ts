...
import { BaseFormComponent } from 'app/entities/base-form/base-form.component';
...
describe('Component Tests', () => {
    describe('BaseForm Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BaseFormComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.baseForms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
