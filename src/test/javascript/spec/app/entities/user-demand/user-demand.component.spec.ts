...
import { UserDemandComponent } from 'app/entities/user-demand/user-demand.component';
...
describe('Component Tests', () => {
    describe('UserDemand Management Component', () => {
        let comp: UserDemandComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UserDemandComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userDemands[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
