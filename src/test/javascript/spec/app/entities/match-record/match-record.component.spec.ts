...
import { MatchRecordComponent } from 'app/entities/match-record/match-record.component';
...
describe('Component Tests', () => {
    describe('MatchRecord Management Component', () => {
        let comp: MatchRecordComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MatchRecordComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.matchRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
