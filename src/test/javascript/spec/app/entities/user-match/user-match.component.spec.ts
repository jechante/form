...
import { UserMatchComponent } from 'app/entities/user-match/user-match.component';
...
describe('Component Tests', () => {
    describe('UserMatch Management Component', () => {
        let comp: UserMatchComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UserMatchComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userMatches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
