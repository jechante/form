    ...
    describe('Broker Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/brokers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Broker', () => {
                service.create(new Broker(null)).subscribe(received => {
            ...
            it('should update a Broker', () => {
                service.update(new Broker(123)).subscribe(received => {
