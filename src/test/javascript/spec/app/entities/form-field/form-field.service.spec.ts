    ...
    describe('FormField Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/form-fields';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FormField', () => {
                service.create(new FormField(null)).subscribe(received => {
            ...
            it('should update a FormField', () => {
                service.update(new FormField(123)).subscribe(received => {
