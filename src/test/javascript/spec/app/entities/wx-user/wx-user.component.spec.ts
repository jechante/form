...
import { WxUserComponent } from 'app/entities/wx-user/wx-user.component';
import { WxUserService } from 'app/entities/wx-user/wx-user.service';
import { WxUser } from 'app/shared/model/wx-user.model';

describe('Component Tests', () => {
    describe('WxUser Management Component', () => {
        let comp: WxUserComponent;
        let fixture: ComponentFixture<WxUserComponent>;
        let service: WxUserService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [FormTestModule],
                declarations: [WxUserComponent],
                providers: [
                    {
                ...
                .overrideTemplate(WxUserComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(WxUserComponent);
