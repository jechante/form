    ...
    describe('Algorithm Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/algorithms';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Algorithm', () => {
                service.create(new Algorithm(null)).subscribe(received => {
            ...
            it('should update a Algorithm', () => {
                service.update(new Algorithm(123)).subscribe(received => {
