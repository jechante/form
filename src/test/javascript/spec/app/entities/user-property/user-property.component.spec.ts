...
import { UserPropertyComponent } from 'app/entities/user-property/user-property.component';
...
describe('Component Tests', () => {
    describe('UserProperty Management Component', () => {
        let comp: UserPropertyComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UserPropertyComponent, '')
                .compileComponents();
